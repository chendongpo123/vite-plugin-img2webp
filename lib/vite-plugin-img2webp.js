/*!
 * vite-plugin-img2webp v1.0.0
 * (c) Mon Feb 26 2024 10:58:13 GMT+0800 (中国标准时间) chendongpo123
...
class Ignore {
    ...
    static includeDir(id, options) {
        ...
        for (let i = 0; i < include.length; i++) {
            let dir = include[i];
            if (dir) {
                dir = dir.split(path__default["default"].sep).join('/');
            }
